...
l1=Label(window,text="Module")
l1.grid(row=0,column=0)

l2=Label(window,text="Roles")
l2.grid(row=0,column=2)

l3=Label(window,text="Tasklists")
l3.grid(row=1,column=0)

l4=Label(window,text="Tasks")
...
b2=Button(window,text="Upload",width=12)
b2.grid(row=2,column=3)

lstbx=Listbox(window,height=6,width=35)
lstbx.grid(row=3,column=0,rowspan=8,columnspan=2)

scrbr=Scrollbar(window)
scrbr.grid(row=3,column=2,rowspan=8)
